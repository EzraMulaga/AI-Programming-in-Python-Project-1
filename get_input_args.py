...
# Main block to check the function if running directly
if __name__ == "__main__":
    # Call the function and print the arguments to verify
    args = get_input_args()
    print(f"Image folder path: {args.dir}")
    print(f"CNN model architecture: {args.arch}")
    print(f"Dog names file: {args.dogfile}")
